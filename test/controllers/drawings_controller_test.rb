...
class DrawingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drawing" do
    assert_difference('Drawing.count') do
      post drawings_url, params: { drawing: { checked_out: @drawing.checked_out, creator: @drawing.creator, height: @drawing.height, title: @drawing.title } }, as: :json
    end
  ...
  test "should update drawing" do
    patch drawing_url(@drawing), params: { drawing: { checked_out: @drawing.checked_out, creator: @drawing.creator, height: @drawing.height, title: @drawing.title } }, as: :json
    assert_response 200
  end
